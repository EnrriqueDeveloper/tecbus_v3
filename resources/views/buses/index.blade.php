...
<div class="bienv">
<div class="py-12 mt-[-12px] ml-[-170px]">
                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">{{ $bus->placa }}</td>
                            <td style="text-align:center">{{ $bus->estado }}</td>
                            <td class="border px-4 py2">
                                <div class="flex justify-center rounded-lg text-lg" role="group">
                                    <!-- boton editar -->
                                    <a href="{{ route('buses.edit', $bus->id) }}" class="bg-gray-900 hover:bg-gray-400 rounded text-white font-bold py-2 px-4">Editar</a>
                                    <!-- boton borrar -->
                                    <form action="{{ route('buses.destroy', $bus->id) }}" method="POST" class="formEliminar">
                                        @csrf
                                        @method('DELETE')
